...
This is the `.carta/` workspace for **FreeAndOpenCell**. It contains structured specifications that humans and AI agents can read, write, and reconcile against code.
