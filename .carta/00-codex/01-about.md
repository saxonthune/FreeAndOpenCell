...
This is the `.carta/` workspace for **FreeAndOpenCell**. It contains structured specifications that bridge the gap between what you want to build and what the code actually does.
